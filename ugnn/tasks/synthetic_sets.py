...
class EntropyTask(RegressionTask):
    def __init__(
        ...
        **kwargs
        ...
        for graph in range(graphs):
            x[graph * nodes:(graph * nodes + generated[graph][1]), :] = rotate(x[graph * nodes:(graph * nodes + generated[graph][1]), :])
            labels[graph * nodes:(graph * nodes+generated[graph][1])] = replicate(x[graph * nodes:(graph * nodes+generated[graph][1]), :])
